...
'''
example1 is much like example0 except it repeats the whole 
...
################# this is the part taht's different from example0:
m=meshPython2Foam.half2N_y1(m,4) # mirror the mesh and repeat it 4 times along y, adjust the boundaries
